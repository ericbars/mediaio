...
const char program_name1[] = "ffprobe";
const int program_birth_year1 = 2007;
...
#define SECTION_FLAG_HAS_VARIABLE_FIELDS 4 ///< the section may contain a variable number of fields with variable keys.
    ...
    int flags;
    int children_ids[
            SECTION_MAX_NB_CHILDREN + 1]; ///< list of children section IDS, terminated by -1
...
static struct section sections[] = {
        [SECTION_ID_CHAPTERS] =           {SECTION_ID_CHAPTERS, "chapters", SECTION_FLAG_IS_ARRAY,
        ...
        [SECTION_ID_CHAPTER_TAGS] =       {SECTION_ID_CHAPTER_TAGS, "tags",
                                           ...
                                           {-1}, .element_name = "tag", .unique_name = "chapter_tags"},
        ...
        [SECTION_ID_FORMAT_TAGS] =        {SECTION_ID_FORMAT_TAGS, "tags",
                                           SECTION_FLAG_HAS_VARIABLE_FIELDS,
                                           {-1}, .element_name = "tag", .unique_name = "format_tags"},
        ...
        [SECTION_ID_FRAME_TAGS] =         {SECTION_ID_FRAME_TAGS, "tags",
                                           SECTION_FLAG_HAS_VARIABLE_FIELDS,
                                           {-1}, .element_name = "tag", .unique_name = "frame_tags"},
        [SECTION_ID_FRAME_SIDE_DATA_LIST] ={SECTION_ID_FRAME_SIDE_DATA_LIST, "side_data_list",
                                            SECTION_FLAG_IS_ARRAY, {SECTION_ID_FRAME_SIDE_DATA,
                                                                    -1}, .element_name = "side_data", .unique_name = "frame_side_data_list"},
        [SECTION_ID_FRAME_SIDE_DATA] =     {SECTION_ID_FRAME_SIDE_DATA, "side_data", 0, {-1}},
        [SECTION_ID_FRAME_LOGS] =         {SECTION_ID_FRAME_LOGS, "logs", SECTION_FLAG_IS_ARRAY,
                                           {SECTION_ID_FRAME_LOG, -1}},
        [SECTION_ID_FRAME_LOG] =          {SECTION_ID_FRAME_LOG, "log", 0, {-1},},
        [SECTION_ID_LIBRARY_VERSIONS] =   {SECTION_ID_LIBRARY_VERSIONS, "library_versions",
                                           SECTION_FLAG_IS_ARRAY, {SECTION_ID_LIBRARY_VERSION, -1}},
        [SECTION_ID_LIBRARY_VERSION] =    {SECTION_ID_LIBRARY_VERSION, "library_version", 0, {-1}},
        [SECTION_ID_PACKETS] =            {SECTION_ID_PACKETS, "packets", SECTION_FLAG_IS_ARRAY,
                                           {SECTION_ID_PACKET, -1}},
        [SECTION_ID_PACKETS_AND_FRAMES] = {SECTION_ID_PACKETS_AND_FRAMES, "packets_and_frames",
                                           SECTION_FLAG_IS_ARRAY, {SECTION_ID_PACKET, -1}},
        [SECTION_ID_PACKET] =             {SECTION_ID_PACKET, "packet", 0, {SECTION_ID_PACKET_TAGS,
                                                                            SECTION_ID_PACKET_SIDE_DATA_LIST,
                                                                            -1}},
        [SECTION_ID_PACKET_TAGS] =        {SECTION_ID_PACKET_TAGS, "tags",
                                           SECTION_FLAG_HAS_VARIABLE_FIELDS,
                                           {-1}, .element_name = "tag", .unique_name = "packet_tags"},
        [SECTION_ID_PACKET_SIDE_DATA_LIST] ={SECTION_ID_PACKET_SIDE_DATA_LIST, "side_data_list",
                                             SECTION_FLAG_IS_ARRAY, {SECTION_ID_PACKET_SIDE_DATA,
                                                                     -1}, .element_name = "side_data", .unique_name = "packet_side_data_list"},
        [SECTION_ID_PACKET_SIDE_DATA] =     {SECTION_ID_PACKET_SIDE_DATA, "side_data", 0, {-1}},
        [SECTION_ID_PIXEL_FORMATS] =      {SECTION_ID_PIXEL_FORMATS, "pixel_formats",
                                           SECTION_FLAG_IS_ARRAY, {SECTION_ID_PIXEL_FORMAT, -1}},
        [SECTION_ID_PIXEL_FORMAT] =       {SECTION_ID_PIXEL_FORMAT, "pixel_format", 0,
                                           {SECTION_ID_PIXEL_FORMAT_FLAGS,
                                            SECTION_ID_PIXEL_FORMAT_COMPONENTS, -1}},
        [SECTION_ID_PIXEL_FORMAT_FLAGS] = {SECTION_ID_PIXEL_FORMAT_FLAGS, "flags", 0,
                                           {-1}, .unique_name = "pixel_format_flags"},
        [SECTION_ID_PIXEL_FORMAT_COMPONENTS] = {SECTION_ID_PIXEL_FORMAT_COMPONENTS, "components",
                                                SECTION_FLAG_IS_ARRAY,
                                                {SECTION_ID_PIXEL_FORMAT_COMPONENT,
                                                 -1}, .unique_name = "pixel_format_components"},
        [SECTION_ID_PIXEL_FORMAT_COMPONENT]  = {SECTION_ID_PIXEL_FORMAT_COMPONENT, "component", 0,
                                                {-1}},
        [SECTION_ID_PROGRAM_STREAM_DISPOSITION] = {SECTION_ID_PROGRAM_STREAM_DISPOSITION,
                                                   "disposition", 0,
                                                   {-1}, .unique_name = "program_stream_disposition"},
        [SECTION_ID_PROGRAM_STREAM_TAGS] =        {SECTION_ID_PROGRAM_STREAM_TAGS, "tags",
                                                   SECTION_FLAG_HAS_VARIABLE_FIELDS,
                                                   {-1}, .element_name = "tag", .unique_name = "program_stream_tags"},
        [SECTION_ID_PROGRAM] =                    {SECTION_ID_PROGRAM, "program", 0,
                                                   {SECTION_ID_PROGRAM_TAGS,
                                                    SECTION_ID_PROGRAM_STREAMS, -1}},
        [SECTION_ID_PROGRAM_STREAMS] =            {SECTION_ID_PROGRAM_STREAMS, "streams",
                                                   SECTION_FLAG_IS_ARRAY,
                                                   {SECTION_ID_PROGRAM_STREAM,
                                                    -1}, .unique_name = "program_streams"},
        [SECTION_ID_PROGRAM_STREAM] =             {SECTION_ID_PROGRAM_STREAM, "stream", 0,
                                                   {SECTION_ID_PROGRAM_STREAM_DISPOSITION,
                                                    SECTION_ID_PROGRAM_STREAM_TAGS,
                                                    -1}, .unique_name = "program_stream"},
        [SECTION_ID_PROGRAM_TAGS] =               {SECTION_ID_PROGRAM_TAGS, "tags",
                                                   SECTION_FLAG_HAS_VARIABLE_FIELDS,
                                                   {-1}, .element_name = "tag", .unique_name = "program_tags"},
        [SECTION_ID_PROGRAM_VERSION] =    {SECTION_ID_PROGRAM_VERSION, "program_version", 0, {-1}},
        [SECTION_ID_PROGRAMS] =                   {SECTION_ID_PROGRAMS, "programs",
                                                   SECTION_FLAG_IS_ARRAY, {SECTION_ID_PROGRAM, -1}},
        [SECTION_ID_ROOT] =               {SECTION_ID_ROOT, "root", SECTION_FLAG_IS_WRAPPER,
                                           {SECTION_ID_CHAPTERS, SECTION_ID_FORMAT,
                                            SECTION_ID_FRAMES, SECTION_ID_PROGRAMS,
                                            SECTION_ID_STREAMS,
                                            SECTION_ID_PACKETS, SECTION_ID_ERROR,
                                            SECTION_ID_PROGRAM_VERSION, SECTION_ID_LIBRARY_VERSIONS,
                                            SECTION_ID_PIXEL_FORMATS, -1}},
        [SECTION_ID_STREAMS] =            {SECTION_ID_STREAMS, "streams", SECTION_FLAG_IS_ARRAY,
                                           {SECTION_ID_STREAM, -1}},
        [SECTION_ID_STREAM] =             {SECTION_ID_STREAM, "stream", 0,
                                           {SECTION_ID_STREAM_DISPOSITION, SECTION_ID_STREAM_TAGS,
                                            SECTION_ID_STREAM_SIDE_DATA_LIST, -1}},
        [SECTION_ID_STREAM_DISPOSITION] = {SECTION_ID_STREAM_DISPOSITION, "disposition", 0,
                                           {-1}, .unique_name = "stream_disposition"},
        [SECTION_ID_STREAM_TAGS] =        {SECTION_ID_STREAM_TAGS, "tags",
                                           SECTION_FLAG_HAS_VARIABLE_FIELDS,
                                           {-1}, .element_name = "tag", .unique_name = "stream_tags"},
        [SECTION_ID_STREAM_SIDE_DATA_LIST] ={SECTION_ID_STREAM_SIDE_DATA_LIST, "side_data_list",
                                             SECTION_FLAG_IS_ARRAY, {SECTION_ID_STREAM_SIDE_DATA,
                                                                     -1}, .element_name = "side_data", .unique_name = "stream_side_data_list"},
...
static probeCallback *probe_callback_android = NULL;
...
static const AVOption writer_options[] = {
        {"string_validation",             "set string validation mode",
                                                                                      OFFSET(string_validation),             AV_OPT_TYPE_INT,    {.i64=WRITER_STRING_VALIDATION_REPLACE}, 0,
                WRITER_STRING_VALIDATION_NB - 1, .unit = "sv"},
...
static inline int show_tags(WriterContext *w, AVDictionary *tags, int section_id) {
    ...
    while ((tag = av_dict_get(tags, "", tag, AV_DICT_IGNORE_SUFFIX))) {
        // mediaio add
        // av_log(NULL, AV_LOG_DEBUG, "tag->key = %s, tag->value = %s", tag->key, tag->value);
        if (!strcmp(tag->key, "rotate")) {
            probe_callback_android(33, tag->value);
        }
    ...
    if (frame->nb_side_data) {
        ...
        for (i = 0; i < frame->nb_side_data; i++) {
            ...
            if (sd->type == AV_FRAME_DATA_DISPLAYMATRIX && sd->size >= 9 * 4) {
                ...
                AVDictionaryEntry *tag = av_dict_get(sd->metadata, "name", NULL,
                                                     AV_DICT_MATCH_CASE);
                if (tag)
...
static int show_stream(WriterContext *w, AVFormatContext *fmt_ctx, int stream_idx, InputStream *ist,
    ...
    if (cd = avcodec_descriptor_get(par->codec_id)) {
        ...
        if (AVMEDIA_TYPE_VIDEO == par->codec_type) {
            probe_callback_android(20, cd->name);
        } else if (AVMEDIA_TYPE_AUDIO == par->codec_type) {
            probe_callback_android(30, cd->name);
        }
        if (!do_bitexact) {
    ...
    print_fmt("codec_tag", "0x%04"
            PRIx32, par->codec_tag);
    ...
    switch (par->codec_type) {
        case AVMEDIA_TYPE_VIDEO:
            ...
            //mediaio add
            char buf[256];
            snprintf(buf, 256, "%d", par->width);
            probe_callback_android(21, buf);
            snprintf(buf, 256, "%d", par->height);
            probe_callback_android(22, buf);
            ...
            if (sar.num) {
                ...
                //mediaio add
                snprintf(buf, 256, "%d%c%d", dar.num, ':', dar.den);
                probe_callback_android(23, buf);
        ...
        case AVMEDIA_TYPE_AUDIO:
            ...
            //mediaio add
            snprintf(buf, 256, "%d", par->channels);
            probe_callback_android(31, buf);
            snprintf(buf, 256, "%d", par->sample_rate);
            probe_callback_android(32, buf);
    ...
    if (AVMEDIA_TYPE_VIDEO == par->codec_type) {
        char buf[256];
        float frame_rate = stream->r_frame_rate.num / stream->r_frame_rate.den;
        int frame_rate_int = (int) frame_rate;
        float frame_rate_fraction = frame_rate - frame_rate_int;
        if (frame_rate_fraction > 0.5) {
            snprintf(buf, 256, "%.02f", frame_rate);
        } else {
            snprintf(buf, 256, "%d", frame_rate_int);
        }
        probe_callback_android(24, buf);
    }
    ...
    if (stream->codec->rc_max_rate > 0)
        print_val ("max_bit_rate", stream->codec->rc_max_rate, unit_bit_per_second_str);
    else
...
#define PRINT_DISPOSITION(flagname, name) do {                                \
    ...
    if (do_show_stream_disposition) {
        writer_print_section_header(w, in_program ? SECTION_ID_PROGRAM_STREAM_DISPOSITION
                                                  : SECTION_ID_STREAM_DISPOSITION);
    ...
    if (do_show_stream_tags)
        ret = show_tags(w, stream->metadata,
                        in_program ? SECTION_ID_PROGRAM_STREAM_TAGS : SECTION_ID_STREAM_TAGS);
...
static int show_format(WriterContext *w, InputFile *ifile) {
    ...
    // mediaio add
    if (NULL != fmt_ctx->iformat->name) {
        probe_callback_android(10, fmt_ctx->iformat->name);
        probe_callback_android(11, fmt_ctx->iformat->extensions);
    }
    ...
    if (fmt_ctx->duration > 0) {
        ...
        double secs;
        int hours, mins;
        double seconds = fmt_ctx->duration * av_q2d(AV_TIME_BASE_Q);
        snprintf(buf, 256, "%lld", (int64_t) seconds);
        probe_callback_android(12, buf);
        secs = seconds;
        mins = (int) secs / 60;
        secs = secs - mins * 60;
        hours = mins / 60;
        mins %= 60;
        //snprintf(buf, 256, "%d:%02d:%09.6f", hours, mins, secs);
        snprintf(buf, 256, "%d:%02d:%02d", hours, mins, (int) secs);
        probe_callback_android(13, buf);
    }

    if (size >= 0) {
        char buf[256];
        snprintf(buf, 256, "%lld", size);
        probe_callback_android(14, buf);
...
static void ffprobe_show_program_version(WriterContext *w) {
    ...
    print_fmt("copyright", "Copyright (c) %d-%d the FFmpeg developers",
              program_birth_year1, CONFIG_THIS_YEAR);
...
void show_help_default1(const char *opt, const char *arg) {
...
static const OptionDef real_options[] = {
        ...
        {"sections", OPT_EXIT, {.func_arg = opt_sections},
        ...
        {"count_frames", OPT_BOOL, {(void *) &do_count_frames},
         "count the number of frames per stream"},
        {"count_packets", OPT_BOOL, {(void *) &do_count_packets},
        ...
        {"show_pixel_formats", 0, {(void *) &opt_show_pixel_formats},
         "show pixel format descriptions"},
        {"show_private_data", OPT_BOOL, {(void *) &show_private_data}, "show private data"},
        {"private", OPT_BOOL, {(void *) &show_private_data}, "same as show_private_data"},
        {"bitexact", OPT_BOOL, {&do_bitexact}, "force bitexact output"},
        {"read_intervals", HAS_ARG, {.func_arg = opt_read_intervals}, "set read intervals",
         "read_intervals"},
